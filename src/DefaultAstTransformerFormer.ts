...
export class DefaultAstTransformer {
    ...
    extractAugCodes(parentNode: SourceCodeAst, firstLineNumber = 1) {
        const augCodes = new Array<AugmentingCodeDescriptor2>();
    ...
    private _addAugCodes(parentNode: SourceCodeAst | NestedBlockAstNode,
            parentAugCode: AugmentingCodeDescriptor2 | null,
        ...
        for (let i = 0; i < src.length; i++) {
            ...
            if (n.type === AstBuilder.TYPE_NESTED_BLOCK) {
                ...
                const augCode : AugmentingCodeDescriptor2 = {
    ...
    applyGeneratedCodes(augCode: AugmentingCodeDescriptor2,
    ...
    private _addAugCodeTransforms(
            augCode: AugmentingCodeDescriptor2,
    ...
    extractGenCodeSections(augCode: AugmentingCodeDescriptor2) {
    ...
    private _addNestedGenCodeSections(augCode: AugmentingCodeDescriptor2,
    ...
    _getLastGenCodeSection(augCode: AugmentingCodeDescriptor2) {
